    ...
    <div className="flex flex-1 flex-col">
      ...
      <section className="flex flex-col items-center justify-center min-h-[80vh] px-6">
        <div className="w-full max-w-2xl text-center animate-fade-in">
          <h1 className="text-6xl md:text-7xl font-semibold tracking-tight text-[#1d1d1f] mb-4">
            BWAI
          </h1>
          <p className="text-xl md:text-2xl text-[#6e6e73] mb-12 font-light">
          ...
          <form onSubmit={handleSubmit} className="relative mb-8">
            <input
              ...
              className="w-full rounded-2xl border border-[#d2d2d7] bg-[#fbfbfd] px-6 py-5 text-lg text-center text-[#1d1d1f] placeholder:text-[#86868b] focus:border-[#0071e3] focus:outline-none focus:ring-4 focus:ring-[#0071e3]/10 transition-all"
              maxLength={10}
              autoFocus
            />
            <button
          ...
          <div className="flex flex-wrap justify-center gap-3 animate-fade-in-delay">
            {["AAPL", "NVDA", "TSLA", "MSFT", "AMZN", "GOOG"].map((t) => (
              <button
                ...
                className="rounded-full bg-[#f5f5f7] px-5 py-2.5 text-sm font-medium text-[#1d1d1f] hover:bg-[#e8e8ed] transition-colors"
              >
                {t}
              </button>
            ))}
      ...
      <section className="bg-[#f5f5f7] py-24 px-6">
        <div className="mx-auto max-w-5xl">
          <h2 className="text-4xl font-semibold text-center text-[#1d1d1f] mb-16">
            How it works
          </h2>
          <div className="grid md:grid-cols-3 gap-12">
            <div className="text-center">
              ...
              <h3 className="text-xl font-semibold text-[#1d1d1f] mb-3">Enter a Ticker</h3>
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-semibold text-[#1d1d1f] mb-3">AI Agents Analyze</h3>
              <p className="text-[#6e6e73] leading-relaxed">
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-semibold text-[#1d1d1f] mb-3">Get Synthesis</h3>
              <p className="text-[#6e6e73] leading-relaxed">
